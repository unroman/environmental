...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				WILLOW_BOARDS.get(), WILLOW_BOOKSHELF.get(), WILLOW_LADDER.get(), WILLOW_BEEHIVE.get(), WILLOW_CHEST.get(), TRAPPED_WILLOW_CHEST.get(),
				PINE_BOARDS.get(), PINE_BOOKSHELF.get(), PINE_LADDER.get(), PINE_BEEHIVE.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), PINECONE.get(), WAXED_PINECONE.get(),
				WISTERIA_BOARDS.get(), WISTERIA_BOOKSHELF.get(), WISTERIA_LADDER.get(), WISTERIA_BEEHIVE.get(), WISTERIA_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(),
				CHERRY_BOARDS.get(), CHERRY_BOOKSHELF.get(), CHERRY_LADDER.get(), CHERRY_BEEHIVE.get(), CHERRY_CHEST.get(), TRAPPED_CHERRY_CHEST.get(),
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(
				...
				CHERRY_LEAVES.get(), CHERRY_LEAF_PILE.get(),
				CHEERFUL_CHERRY_LEAVES.get(), CHEERFUL_CHERRY_LEAF_PILE.get(),
				MOODY_CHERRY_LEAVES.get(), MOODY_CHERRY_LEAF_PILE.get(),
		...
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(WILLOW_CHEST.get(), TRAPPED_WILLOW_CHEST.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), WISTERIA_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), CHERRY_CHEST.get(), TRAPPED_CHERRY_CHEST.get());
		...
		this.tag(BlockTags.PLANKS).add(WILLOW_PLANKS.get(), PINE_PLANKS.get(), WISTERIA_PLANKS.get(), CHERRY_PLANKS.get());
		...
		this.tag(BlockTags.REPLACEABLE).add(HANGING_WILLOW_LEAVES.get(), PINK_HANGING_WISTERIA_LEAVES.get(), BLUE_HANGING_WISTERIA_LEAVES.get(), PURPLE_HANGING_WISTERIA_LEAVES.get(), WHITE_HANGING_WISTERIA_LEAVES.get(), GIANT_TALL_GRASS.get(), MYCELIUM_SPROUTS.get(), CUP_LICHEN.get(), BIRD_OF_PARADISE.get(), PINK_DELPHINIUM.get(), BLUE_DELPHINIUM.get(), PURPLE_DELPHINIUM.get(), WHITE_DELPHINIUM.get(), CACTUS_BOBBLE.get());
		...
		this.tag(Tags.Blocks.CHESTS_WOODEN).add(WILLOW_CHEST.get(), TRAPPED_WILLOW_CHEST.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), WISTERIA_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), CHERRY_CHEST.get(), TRAPPED_CHERRY_CHEST.get());
		this.tag(Tags.Blocks.CHESTS_TRAPPED).add(TRAPPED_WILLOW_CHEST.get(), TRAPPED_PINE_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), TRAPPED_CHERRY_CHEST.get());
		...
		this.tag(BlueprintBlockTags.WOODEN_LADDERS).add(WILLOW_LADDER.get(), PINE_LADDER.get(), WISTERIA_LADDER.get(), CHERRY_LADDER.get());
	}
}