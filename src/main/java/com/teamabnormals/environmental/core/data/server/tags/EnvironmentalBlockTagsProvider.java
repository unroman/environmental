...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.CEILING_HANGING_SIGNS).add(WILLOW_HANGING_SIGNS.getFirst().get());
		this.tag(BlockTags.WALL_HANGING_SIGNS).add(WILLOW_HANGING_SIGNS.getSecond().get());
		...
		this.tag(BlueprintBlockTags.WOODEN_CHISELED_BOOKSHELVES);
