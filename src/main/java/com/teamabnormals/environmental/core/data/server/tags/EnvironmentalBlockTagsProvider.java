...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				...
				PLUM_BOARDS.get(), PLUM_BOOKSHELF.get(), PLUM_LADDER.get(), PLUM_BEEHIVE.get(), PLUM_CHEST.get(), TRAPPED_PLUM_CHEST.get(),
		...
		this.tag(BlockTags.BEEHIVES).add(WILLOW_BEEHIVE.get(), PINE_BEEHIVE.get(), WISTERIA_BEEHIVE.get(), PLUM_BEEHIVE.get());
		this.tag(BlockTags.CLIMBABLE).add(WILLOW_LADDER.get(), PINE_LADDER.get(), WISTERIA_LADDER.get(), PLUM_LADDER.get(), PINK_HANGING_WISTERIA_LEAVES.get(), PURPLE_HANGING_WISTERIA_LEAVES.get(), BLUE_HANGING_WISTERIA_LEAVES.get(), WHITE_HANGING_WISTERIA_LEAVES.get());
		...
		this.tag(Tags.Blocks.CHESTS_WOODEN).add(WILLOW_CHEST.get(), TRAPPED_WILLOW_CHEST.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), WISTERIA_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), PLUM_CHEST.get(), TRAPPED_PLUM_CHEST.get());
		this.tag(Tags.Blocks.CHESTS_TRAPPED).add(TRAPPED_WILLOW_CHEST.get(), TRAPPED_PINE_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), TRAPPED_PLUM_CHEST.get());
