...
public class EnvironmentalMenuTypes {
	...
	public static final RegistryObject<MenuType<SlabfishInventoryMenu>> SLABFISH_INVENTORY = MENU_TYPES.register("slabfish_inventory", () -> new MenuType<>(SlabfishInventoryMenu::new, FeatureFlags.DEFAULT_FLAGS));
}
