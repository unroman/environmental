...
public class EnvironmentalBiomes {
	...
	private static Biome pineBarrens(boolean snowy, boolean oldGrowth) {
		...
		return biome(snowy ? Precipitation.SNOW : Precipitation.RAIN, snowy ? -0.2F : 0.4F, snowy ? 0.4F : 0.6F, snowy ? 8828286 : oldGrowth ? 9221482 : 9484136, snowy ? 6789454 : 7578444, 4159204, 329011, 12638463, spawns, generation, null);
	}
